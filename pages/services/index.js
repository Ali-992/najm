          ...
          <div className={`mx-auto max-w-7xl ${en ? '' : 'rtl'}`}>
            ...
            <div className="grid gap-y-6">
              <Card
                ...
                subTitle2={
                  en
                    ? 'including: Bobcat, flatbed, lowbed, Crane, telehanlder, Pickup trucks, highup truck, jcb backhoe, forklift, towerlight, manlift shilbker, scissor lift'
                    : 'بما في ذلك: بوب كات ، رافعة مسطحة ، رافعة منخفضة  ، رافعه شوكية ، شاحنات صغيرة ، شاحنة عالية الجودة ، حفار  ، ، برج ، رافعة شيلبكر ، رافعة مقصية'
                }
